...
find . -iname "*.pv" -print0 | xargs -0 ./pitch_vectors.py normalize --pickle --pickle-database "./midi-normalized.pickle"
# Extract pitch vectors from *.wav files. This will take long (~10 minutes).
# Also pass '--normalize' to directly normalize pitch vectors.
